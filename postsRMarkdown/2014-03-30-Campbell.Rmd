...
I then analyzed these images in ArcMap to insure they had been averaged on a pixel by pixel level, they had but all was not right. They images needed to be georeferenced, due to differences in parameters during each image collection date.  

![Landat](https://dl.dropbox.com/s/k3tagrpqt2mkbnu/ndvi.PNG "Narragansett Bay: Magic Eye")
...
Accomplishing image processing similar to Mat lab is possible using R packages and base R. Especially useful are the image read/write packages that allow you to manipulate images as an array or matrix. My success was limited due to still learning about both R and image processing.
