...
The standard packages that I use to imbed GIS functionality to R are listed below with a bit of annotation on each.
...
2. `rgdal`: This is another of the foundational packages, that is built of the [Geospatial Data Abstraction Library]()
3. `rgeos`:
4. `raster`:
