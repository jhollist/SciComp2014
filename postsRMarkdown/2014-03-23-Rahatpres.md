...
![exdata](https://dl.dropboxusercontent.com/s/50j57r6zfy9d3zg/exampledata.png?dl=1&token_hash=AAHfJatfo4n5H16dh_qLck-hIkzm5IZdsreGc4HZF-brEQ, height=20%)

Try to turn them into something visually and quantitatively meaningful for analysis, like this:

![DOex](https://dl.dropboxusercontent.com/s/j7ibt6mpnwwdwi3/DOtime.png?dl=1&token_hash=AAF43qy0TEdL4cxMW1qdGDVri0xlbgUTg3AZnFzLM9ymKQ, height="60")
...
![upperpond](https://dl.dropboxusercontent.com/s/a0gv1s29ys4d19y/sitemap.png?dl=1&token_hash=AAHw-YDp8k4Y_KDiY_VsDfOp7doSydPd-qm44nI5Q6v29g)
...
![amexamp](https://dl.dropboxusercontent.com/s/e2kpvnmwu4joj6w/AM.png?dl=1&token_hash=AAHNoYLzkVDDJsEKLMQ_V4IOqVG6fGJsLlRuL7SeC-Z9gw)
...
![3d](https://dl.dropboxusercontent.com/s/hqeq5w7lwwwzkcx/383259_10200994441160210_822413854_n.jpg?dl=1&token_hash=AAFp2RvI-kBzeFAOjF4uqz4VJWfys-0vs4esf1NIJl1dmQ)
...
![calc](https://dl.dropboxusercontent.com/s/3rlei49o2scqc8h/Calc.png?dl=1&token_hash=AAGvgWj0BJVhhmHlXi3tE3i1HH_dY4iTDoA8CQz5gTBOgQ)

The end result should be a nice graph like this:

![AMquan](https://dl.dropboxusercontent.com/s/z4ax4fq7aje9jub/amquan2.png?dl=1&token_hash=AAFuiX2V2DqrEvtHZj_qgLwslzIUcX84oLd0zG28LInBfw)
...
```
    for (z in x[["Date"]]){
      ...
      results<-data.frame(totals,history)
       ...
       #answer<-readline("Do you want a graph? Y/N")
       #if (answer== Y){
         #library(ggplot2)
       		#ggplot(results,aes(x=history,y=total)}
		#else(){answer2<-readline("Do you want to save your file? Y/N"))
		#if answer2==Y(){
